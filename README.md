...
### Workflow Steps:
1. **Question Router**: Determines if question is LoTM-related or off-topic
...
7. **Web Search Fallback**: DuckDuckGo search when RAG pipeline fails
